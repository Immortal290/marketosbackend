          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="relative">
              <div className="flex gap-2">
                ...
                />
                <button
                  className="flex items-center gap-2 border-neo border-neo-ink bg-neo-cyan px-6 py-3 font-display font-black uppercase shadow-neo-sm transition-all hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-neo active:translate-x-[1px] active:translate-y-[1px] active:shadow-none"
                >
            ...
            {agents.map((agent) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <NeoBadge tone="success">Running</NeoBadge>
                </div>
                <p className="font-mono text-xs text-black/60">{agent.task}</p>
              </li>
            ))}
          </ul>
        </NeoCard>
