...
class CampaignState(TypedDict):
    ...
    finance_result:          Optional[BudgetCheck]
    send_result:             Optional[SendResult]
    sms_result:              Optional[SendResult]
    social_result:           Optional[SocialResult]
    analytics_result:        Optional[AnalyticsResult]
    monitor_result:          Optional[MonitorResult]
    ab_test_result:          Optional[ABTestResult]
    lead_scoring_result:     Optional[LeadScore]
    competitor_result:       Optional[CompetitorResult]
    seo_result:              Optional[SEOResult]
    reporting_result:        Optional[ReportingResult]
